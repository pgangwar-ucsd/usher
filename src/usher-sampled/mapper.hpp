...
struct Main_Tree_Target {
    ...
    MatOptimize::MAT::Mutations_Collection splited_mutations;
...
#endif
void
set_parent_muts(std::vector<To_Place_Sample_Mutation> &mutations_to_set,const MatOptimize::MAT::Node *node);
